            ...
            ->schema([
                ...
                Forms\Components\Section::make('SEO')
                    ...
                    ->schema([
                        ...
                        // Тот же визуальный редактор, что у страниц и тизера коллекции:
                        // в SEO-тексте нужны заголовки, списки и ссылки, а штатный
                        // RichEditor (Trix) вычищает незнакомые теги.
                        \App\Forms\Components\HtmlEditor::make('seo_text')
                            ->label('Текст под каталогом')
                            ->minHeight(320)
                            ->columnSpanFull()
                            ->helperText('Необязательно. Показывается внизу страницы категории под товарами — место для описания раздела под поисковые запросы. Заголовки, списки и ссылки правятся как в обычном редакторе, разметку можно посмотреть кнопкой «Исходный код».'),
                    ]),
            ]);
    }
